  ...
  return (
    <div className="rounded-lg  overflow-hidden relative">
      <div className="relative">
        ...
        <div className="flex flex-col absolute bottom-0 w-full max-w-[300px] md:max-w-full bg-black bg-opacity-40 text-white p-4 backdrop-blur-md">
          <Link href={`/shop/${gift._id}`}>
            <h2 className="text-lg font-medium mb-2 text-center md:text-start">
              {gift.name}
            </h2>
          </Link>

          <span className="text-lg text-center md:text-start">
            ${gift.price} USD
          </span>
          <button
            onClick={addToCart}
