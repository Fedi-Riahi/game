...
const FeaturedProducts = () => {
  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row items-center justify-between mx-5 lg:mx-20 my-10 lg:my-20">
        <h1 className="text-white text-2xl font-semibold mb-5 lg:mb-0">
      ...
      <div className="flex flex-wrap justify-center items-center mt-10">
        {products.map((product) => (
          <div
            ...
            style={{ width: "90%", maxWidth: "300px", height: "480px" }}
          >
