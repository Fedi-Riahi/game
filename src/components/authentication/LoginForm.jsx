...
export default function LoginForm() {
  ...
  return (
    <div className="grid place-items-center h-screen bg-white w-full px-4">
      <div className="shadow-lg p-5 rounded-lg border border-gray-400 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col w-full items-center">
          <div className="w-full my-8">
            <input
              ...
              type="text"
              placeholder="Email"
              className="py-3 px-2 w-full border border-gray-300 mb-4"
            />
            <input
          ...
          <button className="w-full bg-gradient-to-r from-blue-500 via-blue-600 to-purple-700 hover:from-blue-600 hover:via-blue-700 hover:to-purple-800 text-white font-semibold py-3 px-8 rounded-tl-lg rounded-br-lg mb-4">
            Login
          </button>
          {error && (
          ...
          <div className="w-full border border-gray-300 my-8" />
          <div className="flex items-center w-full justify-center md:gap-10">
            <p>If you don’t have an account</p>
            <Link
              className="w-2/4 text-center bg-gradient-to-r from-blue-500 via-blue-600 to-purple-700 hover:from-blue-600 hover:via-blue-700 hover:to-purple-800 text-white font-semibold py-3 px-8 rounded-tl-lg rounded-br-lg"
              href={"/register"}
            >
              Register
            </Link>
