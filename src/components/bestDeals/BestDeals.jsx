  ...
  return (
    <div className="mt-20 lg:mt-40 bg-white px-5 lg:px-20">
      ...
      <div className="flex flex-col lg:flex-row items-center mt-10">
        <div className="flex items-start gap-4 flex-1 flex-col mb-10 lg:mb-0">
          <button className="z-10 bg-gradient-to-r from-blue-500 via-blue-600 to-purple-700 hover:from-blue-600 hover:via-blue-700 hover:to-purple-800 text-white font-semibold py-2 px-10 rounded-tl-lg rounded-br-lg">
            Gift Cards
          </button>
        ...
        <div className="flex flex-wrap justify-center lg:justify-start gap-4">
          {products.map((product) => (
            <div
              key={product._id}
              className="max-w-xs flex flex-col py-4 px-2 items-center justify-between bg-blue-950 rounded-lg overflow-hidden shadow-lg m-4 bg-cover bg-center relative"
              style={{
                width: "90%",
                maxWidth: "300px",
                height: "480px",
