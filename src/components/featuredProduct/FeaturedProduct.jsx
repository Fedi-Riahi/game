  ...
  return (
    <section className="py-4 px-5 lg:mx-20 lg:px-0 lg:w-full">
      <div className="flex flex-col lg:flex-row items-center justify-start lg:w-1/2 gap-8 mb-10">
        ...
        <span className="text-gray-300 text-center lg:text-justify lg:flex-1 sm:text-justify">
          More powerful hardware not only better their experiences in games
          they’re currently playing, but it also gives many players access to
      ...
      <div className="flex flex-col lg:flex-row items-center w-full justify-between">
        ...
        {/* Product Card */}
        <div className="flex-1 p-5 border border-gray-300 text-white bg-blue-950 rounded-lg overflow-hidden shadow-lg max-w-full lg:max-w-2xl mx-2 mb-8 lg:mb-0">
          <h2 className="text-xl lg:text-2xl font-semibold my-4">{product.name}</h2>
